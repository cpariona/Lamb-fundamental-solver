...
This plan is complemented by the [Rayleigh-Lamb physical migration audit](rayleigh_lamb_physical_migration_audit.md), which records the risks, preconditions, forbidden changes, rollback approach, and open decisions for any future physical movement or removal of the legacy wrapper folders.
