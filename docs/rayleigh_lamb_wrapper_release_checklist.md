...
Before any future physical migration of the legacy wrapper folders, consult the [Rayleigh-Lamb physical migration audit](rayleigh_lamb_physical_migration_audit.md), apply the [Rayleigh-Lamb migration readiness checklist](rayleigh_lamb_migration_readiness_checklist.md), and review the [Rayleigh-Lamb compatibility snapshot](rayleigh_lamb_compatibility_snapshot.md).
