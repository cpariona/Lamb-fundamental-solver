...
%
% This runner covers the base mRLFE execution surface, naming contracts,
% tracking helpers, residual objective behavior, and lightweight fitting
% contracts. Atlas-specific route/policy contracts are covered by
% tests/run_mrlfe_atlas_tests.m and are called separately by run_all_smoke_tests.
