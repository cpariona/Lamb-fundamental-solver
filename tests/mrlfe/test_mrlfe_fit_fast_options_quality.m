...
assert(rawVisco.fitPerformanceDefaults.a0DpCpScanPoints == 2200, ...
    'Viscous mRLFE fitting should not inherit the reduced elastic A0 DP Cp scan points.');
...
fprintf('Viscous preset:   %s | externalUseInternalGrid=%d | trackingMinPoints=%g | pointFactor=%g\n', ...
    rawVisco.fitPerformanceDefaults.preset, ...
    rawVisco.fitPerformanceDefaults.useInternalTrackingGrid, ...
