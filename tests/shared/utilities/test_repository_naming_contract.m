...
wrapperNames = [ ...
    ...
    "run_mrlfe_route_integrity_tests", "run_mrlfe_production_core_tests", ...
    "run_mrlfe_public_contract_tests", "run_mrlfe_smoke_tests", ...
...
assert(nnz(trackedNames == "run_mrlfe_route_integrity_tests") == 2, ...
    'The route-integrity command must have one public wrapper and one runner implementation.');
