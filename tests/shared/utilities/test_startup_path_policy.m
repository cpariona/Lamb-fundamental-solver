...
publicNames = ["runApp","LambFundamental_GUI","FitTool_GUI","SweepTool_GUI", ...
    "rlDefaultParams","rlDefaultOptions","rlComputeFundamentalLambModes", ...
    "rlComputeAnalyticalApproximations","mrlfeDefaultParameters", ...
    "mrlfeDefaultOptions","mrlfeSolve","defaultAcoustoelasticIOPHGOOptions", ...
