...
assertOwner(repoRoot, 'mrlfeBuildSolveRequest', ...
...
assert(~isfile(fullfile(repoRoot, 'analysis', 'requests', 'mrlfe', ...
    'mrlfeBuildSolveRequest.m')), ...
    'Model-specific mRLFE request translation must not remain analysis-owned.');
