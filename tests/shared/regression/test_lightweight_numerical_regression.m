...
assertNumericClose(mrlfeA0Public.diagnostics.rawInternalResult.frequencySolve_Hz, ...
    fastSolveFrequency_Hz, 1e-12, 'mRLFE A0Like fast internal grid changed.');
assertNumericClose(mrlfeS0Public.diagnostics.rawInternalResult.frequencySolve_Hz, ...
