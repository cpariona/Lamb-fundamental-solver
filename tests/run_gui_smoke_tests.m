...
fprintf('\n[GUI 1/8] GUI normalized adapters smoke test\n');
test_gui_normalized_adapters_smoke;

fprintf('\n[GUI 2/8] GUI sweep adapters smoke test\n');
test_gui_sweep_adapters_smoke;

fprintf('\n[GUI 3/8] GUI sweep registry smoke test\n');
test_gui_sweep_registry_smoke;

fprintf('\n[GUI 4/8] Acoustoelastic IOP/HGO GUI sweep adapter smoke test\n');
test_gui_acoustoelastic_iop_hgo_sweep_adapter_smoke;

fprintf('\n[GUI 5/8] Acoustoelastic IOP/HGO main GUI adapter smoke test\n');
test_gui_acoustoelastic_iop_hgo_main_adapter_smoke;

fprintf('\n[GUI 6/8] GUI fitting backend contract test\n');
test_gui_fit_registry_contract;

fprintf('\n[GUI 7/8] FitTool model registry contract test\n');
test_fit_tool_model_registry_contract;

fprintf('\n[GUI 8/8] GUI mRLFE fixed etaS fit contract test\n');
