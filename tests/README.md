...
Test code lives under app, fitting, models, repository, studies, and sweeps
subfolders. Tooling owns path setup, runtime measurement, and cross-surface profile matrices. Ad hoc
...
The mRLFE solver characterization checks 24 Fast and 6 Dense cases for schema,
requested-frequency coverage, valid output, preset identity, neutral engine
names, and absence of fallback. It is a no-output maintained test and is not a
