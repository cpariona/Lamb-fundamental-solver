...
assert(result.reliability.YStart <= options.atlasMaxStartY, 'YStart must satisfy strict-A0 filter.');
assert(result.reliability.StartRank <= options.atlasMaxStartRank, 'StartRank must satisfy strict-A0 filter.');
