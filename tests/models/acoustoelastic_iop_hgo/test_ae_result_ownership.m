...
assertPath(which('lamb.models.acoustoelastic_iop_hgo.aeSolveBranch'), ...
    fullfile(modelRoot, 'aeSolveBranch.m'), ...
...
ownerFiles = [ ...
    string(fullfile(modelRoot, 'aeSolveBranch.m')); ...
    string(fullfile(modelRoot, '+solvers', 'aeSolveAtlasBranch.m'))];
ownerText = "";
...
result = lamb.models.acoustoelastic_iop_hgo.solvers.aeSolveAtlasBranch(params, options);
