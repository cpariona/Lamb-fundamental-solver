function test_ae_branch_policy_validation()
%TEST_AE_BRANCH_POLICY_VALIDATION Verify maintained branch-policy names.
%
...
diagnosticOptions = lamb.models.acoustoelastic_iop_hgo.aeDefaultOptions('atlasBranchPolicy', "identityA0Diagnostic");
...
fprintf('test_ae_branch_policy_validation passed. atlasA0 is the only production policy.\n');
end
