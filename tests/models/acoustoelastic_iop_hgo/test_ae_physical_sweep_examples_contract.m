...
oldModelPath = fullfile(repoRoot, 'src', '+lamb', '+models', '+acoustoelastic_iop_hgo', '+solvers', 'aeRunSweep.m');
...
for i = 1:numel(cases)
    entryPath = fullfile(repoRoot, 'examples', 'acoustoelastic_iop_hgo', ...
        'sweeps', cases(i).entrypoint + ".m");
...
assert(isfile(fullfile(repoRoot, 'examples', 'acoustoelastic_iop_hgo', ...
