...
cases = [ ...
    ...
    makeCase("ae_sweep_mu_A0Like", "mu", ...
        "mu_kPa = [25, 50, 75, 100]", "mu_sweep"); ...
    makeCase("ae_sweep_thickness_A0Like", "thickness", ...
        "thickness_um = [400, 475, 550, 625, 700]", "thickness_sweep"); ...
    makeCase("ae_sweep_k1_A0Like", "k1", ...
        "k1_kPa = [10, 25, 50, 75, 100]", "k1_sweep"); ...
    makeCase("ae_sweep_k2_A0Like", "k2", ...
        "k2_values = [50, 100, 200, 300, 400]", "k2_sweep"); ...
    makeCase("ae_sweep_radius_A0Like", "R", ...
