...
directResult = lamb.models.acoustoelastic_iop_hgo.solvers.aeSolveAtlasBranch(result.directParams, options);
...
internalResult = lamb.models.acoustoelastic_iop_hgo.aeSolveBranch(params, internalOptions);
