...
assert(contains(mrlfeSection, 'solveMRLFEAtlasUnified'), ...
    'Maintained mRLFE section should list solveMRLFEAtlasUnified.');
assert(contains(mrlfeSection, 'solveMRLFEBranchAdaptiveAtlas'), ...
    'Maintained mRLFE section should list solveMRLFEBranchAdaptiveAtlas.');
...
maintainedFiles = { ...
    ...
    fullfile(repoRoot, 'models', 'mrlfe', 'solvers', 'solveMRLFEAtlasUnified.m'), ...
    fullfile(repoRoot, 'models', 'mrlfe', 'solvers', 'solveMRLFEBranchAdaptiveAtlas.m'), ...
