...
assert(isfield(mainOutput.metadata, 'mrlfeUseUnifiedAtlasRoute') && mainOutput.metadata.mrlfeUseUnifiedAtlasRoute, ...
    'Main GUI mRLFE adapter must preserve mrlfeUseUnifiedAtlasRoute metadata.');
assert(isfield(mainOutput.metadata, 'mrlfeA0Policy') && mainOutput.metadata.mrlfeA0Policy == "adaptivePhysicalTail", ...
    'Main GUI mRLFE adapter must preserve mrlfeA0Policy metadata.');
