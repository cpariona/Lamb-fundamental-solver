...
assert(mrlfeMetadata.effectiveExecutionProfile == "Fast", ...
    'mRLFE Fit should keep effective Fast.');
assert(mrlfeMetadata.profileOverrideApplied == true && strlength(mrlfeMetadata.profileOverrideReason) > 0, ...
    'mRLFE override should carry a stable reason.');
...
assertDocContains(fullfile('docs', 'architecture', 'execution_profiles_cleanup.md'), ...
