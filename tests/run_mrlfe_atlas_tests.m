...
fprintf('\n[mRLFE atlas 1/11] direct atlas option alias contract test\n');
test_mrlfe_direct_visco_atlas_option_alias_contract;

fprintf('\n[mRLFE atlas 2/11] modal atlas ambiguity contract test\n');
test_mrlfe_modal_atlas_ambiguity_contract;

fprintf('\n[mRLFE atlas 3/11] S0 modal atlas contract test\n');
test_mrlfe_modal_atlas_s0_contract;

fprintf('\n[mRLFE atlas 4/11] atlas policy matrix contract test\n');
test_mrlfe_atlas_policy_matrix_contract;

fprintf('\n[mRLFE atlas 5/11] direct-visco branch policy contract test\n');
test_mrlfe_direct_visco_branch_policy_contract;

fprintf('\n[mRLFE atlas 6/11] delayed-visco modal cut contract test\n');
test_mrlfe_delayed_visco_modal_cut_contract;

fprintf('\n[mRLFE atlas 7/11] A0 delayed direct-visco opt-in contract test\n');
test_mrlfe_a0_delayed_direct_visco_opt_in_contract;

fprintf('\n[mRLFE atlas 8/11] A0 delayed direct-visco S0 guard contract test\n');
test_mrlfe_a0_delayed_direct_visco_s0_guard_contract;

fprintf('\n[mRLFE atlas 9/11] unified atlas route contract test\n');
test_mrlfe_unified_atlas_route_contract;

fprintf('\n[mRLFE atlas 10/11] S0 adaptive atlas tracker contract test\n');
test_mrlfe_s0_adaptive_atlas_tracker_contract;

fprintf('\n[mRLFE atlas 11/11] unified atlas mu-sweep contract test\n');
test_mrlfe_unified_atlas_mu_sweep_contract;
