...
%% GUI smoke tests
fprintf('\n[1/21] GUI normalized adapters smoke test\n');
test_gui_normalized_adapters_smoke;

fprintf('\n[2/21] GUI sweep adapters smoke test\n');
test_gui_sweep_adapters_smoke;

fprintf('\n[3/21] GUI sweep registry smoke test\n');
test_gui_sweep_registry_smoke;

fprintf('\n[4/21] Acoustoelastic IOP/HGO GUI sweep adapter smoke test\n');
test_gui_acoustoelastic_iop_hgo_sweep_adapter_smoke;

fprintf('\n[5/21] Acoustoelastic IOP/HGO main GUI adapter smoke test\n');
...
fprintf('\n[6/21] Acoustoelastic atlas branch policy validation test\n');
test_acoustoelastic_iop_hgo_branch_policy_validation;

fprintf('\n[7/21] Acoustoelastic fallback invalidation policy test\n');
test_acoustoelastic_iop_hgo_fallback_invalidation;

fprintf('\n[8/21] Acoustoelastic internal tracking grid test\n');
test_acoustoelastic_iop_hgo_internal_tracking_grid;

fprintf('\n[9/21] Acoustoelastic truncation recovery helper unit test\n');
test_ae_analyze_truncation_recovery;

fprintf('\n[10/21] Acoustoelastic branch-persistence refinement unit test\n');
test_acoustoelastic_iop_hgo_branch_persistence_refinement;

fprintf('\n[11/21] Acoustoelastic IOP/HGO constitutive identity test\n');
test_acoustoelastic_iop_hgo_constitutive_identity;

fprintf('\n[12/21] Acoustoelastic IOP/HGO atlasA0 smoke test\n');
test_acoustoelastic_iop_hgo_atlasA0_smoke;
