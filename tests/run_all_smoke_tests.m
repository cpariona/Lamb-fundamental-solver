...
assert(~isempty(which('aeAnalyzeSweepReliability')), ...
    'Missing aeAnalyzeSweepReliability on MATLAB path.');
assert(~isempty(which('aeAnalyzeTruncationCase')), ...
    'Missing aeAnalyzeTruncationCase on MATLAB path.');
assert(~isempty(which('aeAnalyzeTruncationRecovery')), ...
    'Missing aeAnalyzeTruncationRecovery on MATLAB path.');
assert(~isempty(which('aeAnalyzeFirstUnrecoveredBreak')), ...
    'Missing aeAnalyzeFirstUnrecoveredBreak on MATLAB path.');
assert(~isempty(which('aeAnalyzeBreakThresholdSensitivity')), ...
    'Missing aeAnalyzeBreakThresholdSensitivity on MATLAB path.');
assert(~isempty(which('aeCompareThresholdRelaxedBranch')), ...
    'Missing aeCompareThresholdRelaxedBranch on MATLAB path.');
assert(~isempty(which('aeAssessThresholdRelaxedBranchQuality')), ...
    'Missing aeAssessThresholdRelaxedBranchQuality on MATLAB path.');
assert(~isempty(which('aeClassifyThresholdRelaxedBranchDecision')), ...
    'Missing aeClassifyThresholdRelaxedBranchDecision on MATLAB path.');
assert(~isempty(which('aeClassifyTruncationRecovery')), ...
    'Missing aeClassifyTruncationRecovery on MATLAB path.');
assert(~isempty(which('aeSummarizeTruncationRecoveryClassification')), ...
    'Missing aeSummarizeTruncationRecoveryClassification on MATLAB path.');
assert(~isempty(which('aeAnalyzeBranchPersistenceCandidates')), ...
    'Missing aeAnalyzeBranchPersistenceCandidates on MATLAB path.');
assert(~isempty(which('aeRefineAtlasA0BranchPersistence')), ...
    'Missing aeRefineAtlasA0BranchPersistence on MATLAB path.');
assert(~isempty(which('aeDiagnoseAtlasA0TruncationCause')), ...
    'Missing aeDiagnoseAtlasA0TruncationCause on MATLAB path.');
...
assert(~isempty(which('diagnose_acoustoelastic_iop_hgo_sweep_reliability')), ...
    'Missing diagnose_acoustoelastic_iop_hgo_sweep_reliability on MATLAB path.');
assert(~isempty(which('diagnose_acoustoelastic_iop_hgo_truncation_cases')), ...
    'Missing diagnose_acoustoelastic_iop_hgo_truncation_cases on MATLAB path.');
assert(~isempty(which('diagnose_acoustoelastic_iop_hgo_branch_persistence_refinement')), ...
    'Missing diagnose_acoustoelastic_iop_hgo_branch_persistence_refinement on MATLAB path.');
assert(~isempty(which('diagnose_acoustoelastic_iop_hgo_atlasA0_truncation_cause')), ...
    'Missing diagnose_acoustoelastic_iop_hgo_atlasA0_truncation_cause on MATLAB path.');
assert(~isempty(which('diagnose_acoustoelastic_iop_hgo_atlasA0_resolution_sensitivity')), ...
    'Missing diagnose_acoustoelastic_iop_hgo_atlasA0_resolution_sensitivity on MATLAB path.');
assert(~isempty(which('diagnose_acoustoelastic_iop_hgo_failure_landscape')), ...
    'Missing diagnose_acoustoelastic_iop_hgo_failure_landscape on MATLAB path.');
...
assert(~isempty(which('test_ae_analyze_truncation_recovery')), ...
    'Missing test_ae_analyze_truncation_recovery on MATLAB path.');
assert(~isempty(which('test_acoustoelastic_iop_hgo_branch_persistence_refinement')), ...
    'Missing test_acoustoelastic_iop_hgo_branch_persistence_refinement on MATLAB path.');

fprintf('\n[2/7] Acoustoelastic IOP/HGO branch policy alias test\n');
...
fprintf('\n[6/7] Acoustoelastic IOP/HGO legacy strict-A0 atlas branch smoke test\n');
