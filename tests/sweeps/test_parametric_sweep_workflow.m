...
sweep = lamb.sweeps.runParametricSweep(baseParams, baseOptions, spec, @evaluateCondition);
...
nested = lamb.sweeps.runParametricSweep(baseParams, nestedOptions, nestedSpec, @evaluateNested);
