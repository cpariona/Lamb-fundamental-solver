...
outputFolder = resolveStudyOutputFolder(launchFolder, 'ae_iop_hgo', 'sweep_reliability');
...
specs(1).workspacePath = fullfile(launchFolder, 'Results', 'ae_iop_hgo', ...
    'iop_sweep', 'iop_sweep_workspace.mat');
...
specs(2).workspacePath = fullfile(launchFolder, 'Results', 'ae_iop_hgo', ...
    'mu_sweep', 'mu_sweep_workspace.mat');
