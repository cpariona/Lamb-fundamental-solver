...
outputFolder = resolveStudyOutputFolder(launchFolder, 'ae_iop_hgo', 'atlas_truncation');
...
cases(1).workspacePath = fullfile(launchFolder, 'Results', 'ae_iop_hgo', ...
...
cases(3).workspacePath = fullfile(launchFolder, 'Results', 'ae_iop_hgo', ...
