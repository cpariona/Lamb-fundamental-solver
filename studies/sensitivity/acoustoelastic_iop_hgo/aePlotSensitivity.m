function fig = aePlotSensitivity(sweepResult, varargin)
%AEPLOTSENSITIVITY Plot AE IOP/HGO sensitivity curves with the shared renderer.
...
plotData = aeBuildSensitivityPlotData(sweepResult);
fig = plotSweepCpFigure(plotData, ...
    'Title', p.Results.Title, ...
    'FigureName', "AE IOP/HGO sensitivity Cp", ...
