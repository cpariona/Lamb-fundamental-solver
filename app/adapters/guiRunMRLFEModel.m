...
profileMetadata.etaS = getEtaS(options);
profileMetadata.useUnifiedAtlasRoute = useViscousAtlas;
profileMetadata.a0Policy = options.mrlfeA0Policy;
profileMetadata.fallback = zeroViscosityFallback;
