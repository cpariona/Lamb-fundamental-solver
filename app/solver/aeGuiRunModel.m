...
profileInput = guiGetStructField(guiRequest, 'executionProfile', ...
    guiGetStructField(options, 'executionProfileMetadata', struct()));
if isstruct(profileInput) && isfield(profileInput, 'requestedExecutionProfile')
    profileInput = profileInput.requestedExecutionProfile;
end
[options, profileMetadata] = aeResolveExecutionProfile(profileInput, ...
