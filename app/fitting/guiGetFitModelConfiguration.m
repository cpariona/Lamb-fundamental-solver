...
family.parameters = [ ...
    ...
    makeParameter("nu", "nu", "Poisson ratio", "", "", 1, 0.4999, [0.49, 0.49999], false, "fixedParams", ...
        "Production RL supports 0.49 <= nu < 0.5. Fixed by default; values are never clipped.") ...
    ];
end
...
family.parameters = [ ...
    ...
    makeParameter("rho", "rho", "Density", "kg/m^3", "kg/m^3", 1, 1070, [500, 2000], false, "fixedParams", ...
        "Mass density. Fixed by default."), ...
    makeParameter("nu", "nu", "Poisson ratio", "", "", 1, 0.4999, [0.49, 0.49999], false, "fixedParams", ...
        "The public RL seed requires 0.49 <= nu < 0.5. Fixed by default; values are never clipped."), ...
    makeParameter("fluidDensity", "fluidDensity", "Fluid density", "kg/m^3", "kg/m^3", 1, physicalDefaults.fluidDensity_kgm3, [1, 2000], false, "controls", ...
        "Fluid density. Stored in solver options."), ...
    makeParameter("fluidSoundSpeed", "fluidSoundSpeed", "Fluid sound speed", "m/s", "m/s", 1, physicalDefaults.fluidSoundSpeed_mps, [1, 3000], false, "controls", ...
