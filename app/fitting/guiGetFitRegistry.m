...
family.supportedModes = ["basic", "assisted"];
family.parameters = [ ...
    makeParameter("mu", "mu", "Shear modulus", "Pa", "kPa", 1e3, 50e3, [1e3, 300e3], true, ...
        "Ground-matrix shear modulus for HGO constitutive block."), ...
    makeParameter("IOP", "IOP", "IOP", "Pa", "mmHg", 133.322, 15 * 133.322, [1, 50] * 133.322, true, ...
        "Intraocular pressure-like load."), ...
    makeParameter("thickness", "thickness", "Thickness", "m", "um", 1e-6, 550e-6, [250e-6, 900e-6], true, ...
        "Corneal or plate thickness."), ...
    makeParameter("R", "R", "Radius", "m", "mm", 1e-3, 7.8e-3, [4e-3, 12e-3], false, ...
        "Curvature radius used to compute prestress."), ...
    makeParameter("k1", "k1", "HGO k1", "Pa", "kPa", 1e3, 25e3, [0, 300e3], false, ...
        "HGO fiber stiffness parameter."), ...
    makeParameter("k2", "k2", "HGO k2", "", "", 1, 100, [0, 500], false, ...
        "HGO exponential parameter."), ...
    makeParameter("rho", "rho", "Density", "kg/m^3", "kg/m^3", 1, 1060, [500, 2000], false, ...
        "Solid density."), ...
    makeParameter("rhoF", "rhoF", "Fluid density", "kg/m^3", "kg/m^3", 1, 1000, [1, 2000], false, ...
        "Lower-fluid density."), ...
    makeParameter("fluidBulkModulus", "fluidBulkModulus", "Fluid bulk modulus", "Pa", "GPa", 1e9, 2.2e9, [0.1e9, 5e9], false, ...
        "Fluid bulk modulus.") ...
    ];
end
