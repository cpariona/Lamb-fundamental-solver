...
family.supportedModes = ["basic", "assisted"];
family.parameters = [ ...
    makeParameter("mu", "mu", "Shear modulus", "Pa", "kPa", 1e3, 50e3, [1e3, 300e3], true, "fixedParams", ...
    ...
    makeParameter("k1", "k1", "HGO k1", "Pa", "kPa", 1e3, 25e3, [0, 300e3], false, "fixedParams", ...
        "HGO fiber stiffness parameter."), ...
    makeParameter("k2", "k2", "HGO k2", "", "", 1, 100, [0, 500], false, "fixedParams", ...
