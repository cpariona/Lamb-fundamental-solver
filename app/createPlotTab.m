...
header = uilabel(g, 'Text', 'Acoustoelastic IOP/HGO', 'FontWeight', 'bold', 'VerticalAlignment', 'center');
header.Layout.Row = 5;
header.Layout.Column = [1 4];

h.showAE = uicheckbox(g, 'Text', 'AE A0-like', 'Value', true, 'ValueChangedFcn', callbacks.refreshPlotOnly);
h.showAE.Layout.Row = 6;
h.showAE.Layout.Column = [1 4];
...
note = uilabel(g, 'Text', 'Visibility affects plotting only. Internal helper branches may still be computed by some models.', ...
