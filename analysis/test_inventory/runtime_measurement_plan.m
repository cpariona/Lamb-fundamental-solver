...
Automatic = [true(20, 1); false(7, 1)];
EvidencePolicy = [ ...
    repmat("measure in phase 1", 20, 1); ...
    "retain supplied 36-case, 178.7-second evidence; do not rerun"; ...
    "obsolete mapped-to-Fast assertion; defer until redesign"; ...
