...
switch string(scenario.Model)
    ...
    case "mRLFE"
        ...
        metadata = out.metadata.executionProfile;
        notes = "mRLFE main route " + string(out.metadata.mrlfeGuiActualRoute);
    otherwise
...
switch string(scenario.Model)
    ...
    case "mRLFE"
        ...
        controls = struct('executionProfile', profile, ...
            ...
            'mrlfeUseUnifiedAtlasRoute', scenario.EtaS > 0, ...
            'mrlfeA0Policy', "adaptivePhysicalTail");
...
options.mrlfeUseUnifiedAtlasRoute = etaS > 0;
...
request = guiBuildFitRequest("mrlfe", ...
    ...
    'controls', struct('executionProfile', profile, ...
        ...
        'fluidDensity', 1000, ...
        'fluidSoundSpeed', 1500, ...
        'mrlfeUseUnifiedAtlasRoute', true, ...
        'mrlfeA0Policy', "adaptivePhysicalTail"), ...
    'fitOptions', shortFitOptions(1, 3, 1e-4));
end
