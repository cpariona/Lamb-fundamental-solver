...
if modelFamily == "acoustoelastic_iop_hgo" && isfield(fitResult.rawSolverResult, 'solverResult') && ...
        isfield(fitResult.rawSolverResult.solverResult, 'reliability') && ...
        isfield(fitResult.rawSolverResult.solverResult.reliability, 'SelectionFallbackUsed') && ...
        fitResult.rawSolverResult.solverResult.reliability.SelectionFallbackUsed
