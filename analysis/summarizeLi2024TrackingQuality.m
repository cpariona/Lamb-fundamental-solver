function summaryTable = summarizeLi2024TrackingQuality(results, labels, varargin)
%SUMMARIZELI2024TRACKINGQUALITY Summarize Li 2024 tracking quality metrics.
%
% summaryTable = summarizeLi2024TrackingQuality(results, labels)
%
% Inputs:
%   results : cell array of Li2024 result structs. Supports real-Cp results
