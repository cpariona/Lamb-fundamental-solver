...
% standardError_Cp_mps are optional. FITCONFIG owns branch, fixed/free
% parameters, initial guess, bounds, solver options, and optimizer controls.
% Every physical evaluation routes through lamb.models.mrlfe.mrlfeSolve.
% Objective evaluation may use the bounded fitOptimized continuation grid;
% explicit requested-curve evaluation uses the selected numerical preset.
%
