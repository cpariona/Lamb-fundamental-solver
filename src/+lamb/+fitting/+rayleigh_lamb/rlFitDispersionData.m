...
% validMask and standardError_Cp_mps are optional. FITCONFIG supplies the
% branch, fixed/free parameters, initial guess, bounds, solver options, and
% optimizer controls. The evaluator tracks one coherent A0 or S0 branch on
% a continuation grid containing every experimental frequency and disables
% prediction fallback.
%
