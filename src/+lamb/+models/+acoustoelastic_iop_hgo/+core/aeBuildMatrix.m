function [M, aux] = aeBuildMatrix(alpha, beta, gamma, h, rho, rhoF, fluidBulkModulus, f, c, options, cpState)
%AEBUILDMATRIX Build the 5x5 acoustoelastic matrix.
%
...
if nargin < 11 || isempty(cpState)
    cpState = lamb.models.acoustoelastic_iop_hgo.core.aeComputeCpState(alpha, beta, gamma, rho, rhoF, fluidBulkModulus, c);
end
