function [objectiveValue, details] = aeObjectiveComplexDeterminant(alpha, beta, gamma, h, rho, rhoF, fluidBulkModulus, f, cComplex, options)
%AEOBJECTIVECOMPLEXDETERMINANT Complex determinant objective.
%
...
[M, aux] = lamb.models.acoustoelastic_iop_hgo.core.aeBuildMatrix(alpha, beta, gamma, h, rho, rhoF, fluidBulkModulus, f, cComplex, options);
detM = det(M);
absDet = abs(detM);
