function state = aeComputeAcoustoelasticCpState(alpha, beta, gamma, rho, rhoF, fluidBulkModulus, c)
%AECOMPUTEACOUSTOELASTICCPSTATE Precompute AE quantities that depend only on Cp.

[s1, s2, rootInfo] = lamb.models.acoustoelastic_iop_hgo.core.computeAcoustoelasticSRoots(alpha, beta, gamma, rho, c);
