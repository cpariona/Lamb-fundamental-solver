function state = aeComputeCpState(alpha, beta, gamma, rho, rhoF, fluidBulkModulus, c)
%AECOMPUTECPSTATE Precompute AE quantities that depend only on Cp.

[s1, s2, rootInfo] = lamb.models.acoustoelastic_iop_hgo.core.aeComputeSRoots(alpha, beta, gamma, rho, c);
