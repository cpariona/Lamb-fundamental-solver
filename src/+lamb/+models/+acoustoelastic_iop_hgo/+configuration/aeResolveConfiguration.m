...
if strlength(string(p.Results.NumericalPreset)) > 0
    [presetValues, requestedPreset] = lamb.models.acoustoelastic_iop_hgo.configuration.aeGetNumericalPreset(p.Results.NumericalPreset);
...
for i = 1:numel(profiles)
    preset = lamb.models.acoustoelastic_iop_hgo.configuration.aeGetNumericalPreset(profiles(i));
