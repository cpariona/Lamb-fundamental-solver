...
%
% Result and quality rebuilding remain with lamb.models.acoustoelastic_iop_hgo.results.aeBuildResult and
% lamb.models.acoustoelastic_iop_hgo.quality.aeEvaluateAtlasA0Quality. This owner changes only the already-decided
