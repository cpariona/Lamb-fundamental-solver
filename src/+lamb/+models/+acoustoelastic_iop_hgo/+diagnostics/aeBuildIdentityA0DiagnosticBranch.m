...
% missing frequencies where lamb.models.acoustoelastic_iop_hgo.diagnostics.aeScoreBranchIdentityCandidates finds a strong or
% caution candidate. It never modifies the official result.

score = lamb.models.acoustoelastic_iop_hgo.diagnostics.aeScoreBranchIdentityCandidates(result, varargin{:});
