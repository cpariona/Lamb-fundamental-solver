...
%
% residual = lamb.models.mrlfe.core.mrlfeObjectiveResidual(k, omega, material, geometry, mrlfeParams)
...
%
% residual = lamb.models.mrlfe.core.mrlfeObjectiveResidual(..., 'Method', method) supports:
%
...
M = lamb.models.mrlfe.core.mrlfeMatrix(k, omega, material, geometry, mrlfeParams);
if any(~isfinite(M(:)))
    residual = inf;
    return;
end
