...
quality = lamb.models.mrlfe.quality.mrlfeEvaluateBranchQuality(frequency_Hz, phaseVelocity_mps, validMask, configuration.qualityOptions);
...
result.execution = struct( ...
    'engine', configuration.internalEngine, ...
