...
baseBranch = lamb.models.mrlfe.tracking.mrlfeTrackBranchAdaptive(problem, seedMode, configuration, mrlfeParams, options);
...
for i = 1:numel(candidateIndices)
    ...
    probeSeed = lamb.models.mrlfe.tracking.mrlfeBuildSeed(probeProblem, configuration);
    probeBranch = lamb.models.mrlfe.tracking.mrlfeTrackBranchAdaptive(probeProblem, probeSeed, configuration, mrlfeParams, options);
...
forwardSeed = lamb.models.mrlfe.tracking.mrlfeBuildSeed(forwardProblem, configuration);
forwardBranch = lamb.models.mrlfe.tracking.mrlfeTrackBranchAdaptive(forwardProblem, forwardSeed, configuration, mrlfeParams, options);
...
problemOut = lamb.models.mrlfe.core.mrlfeBuildProblem(configurationOut);
