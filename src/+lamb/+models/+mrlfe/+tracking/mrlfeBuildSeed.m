...
seedOptions = lamb.models.rayleigh_lamb.rlDefaultOptions("Fast");
seedOptions.computeA0 = branchName == "A0Like";
seedOptions.computeS0 = branchName == "S0Like";
seedResult = lamb.models.rayleigh_lamb.rlComputeFundamentalLambModes(problem.params, seedOptions);
