% Stress-test viscoelastic real-k mRLFE stability.
%
% This diagnostic checks whether the Kelvin-Voigt shear-viscosity mRLFE model
% remains trackable over practical elastic stiffness and viscosity ranges. It
% uses the elastic mRLFE real-k solution as reference before solving the
% viscoelastic branch.
%
% Model:
...
fprintf('\nmRLFE viscoelastic real-k stability sweep\n');
fprintf('------------------------------------------\n');
...
mRLFEViscoRangeStabilitySummary = rowsToTable(summaryRows);
writetable(mRLFEViscoRangeStabilitySummary, 'mRLFE_visco_range_stability_summary.csv');

assignin('base', 'mRLFEViscoRangeStabilityResults', resultsByCase);
assignin('base', 'mRLFEViscoRangeStabilitySummary', mRLFEViscoRangeStabilitySummary);
assignin('base', 'mRLFEViscoRangeStabilityEValues', EValues);
assignin('base', 'mRLFEViscoRangeStabilityEtaSValues', etaSValues);
assignin('base', 'mRLFEViscoRangeStabilityLargeJumpThreshold', largeJumpThreshold);
