...
rowTemplate = struct( ...
    ...
    'thickness_mm', nan, ...
    'fmax_Hz', nan, ...
    'referenceStep_Hz', nan, ...
    'candidateStep_Hz', nan, ...
    'referenceElapsed_s', nan, ...
    'candidateElapsed_s', nan, ...
    'speedup', nan, ...
    'commonValidFraction', nan, ...
    'validMaskDifferences', nan, ...
    'medianRelativeError', nan, ...
    'p95RelativeError', nan, ...
    'maxRelativeError', nan, ...
    'referenceLastValid_Hz', nan, ...
    'candidateLastValid_Hz', nan, ...
    'referenceTerminationPolicy', "", ...
    'candidateTerminationPolicy', "", ...
    'referenceTerminationApplied', false, ...
    'candidateTerminationApplied', false, ...
    'referenceQuality', "", ...
    'candidateQuality', "");
...
for name = candidates
    if isfield(result.quality, name) && ~isempty(result.quality.(name))
        value = string(result.quality.(name));
        label = value(1);
        return;
    end
end
