...
% low-frequency modal-atlas outputs.
%
% Preferred input:
...
try
    ...
    fprintf('raw_branch1_curve.csv not found. Regenerating from modal_atlas_lowfreq outputs.\n');
    ...
    if ~exist(rawCurveFile, 'file')
        error('Failed to regenerate raw_branch1_curve.csv. Run diagnose_modal_atlas_lowfreq first.');
    end
end
end
