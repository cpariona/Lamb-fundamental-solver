...
hold on; grid on;
plot(points.Frequency_kHz, points.RawCp_mps, '-', 'LineWidth', 2.5, 'DisplayName', 'raw\_branch1');
...
ylabel('Cp [m/s]');
title(sprintf('atlasA0 and identityA0 versus raw\_branch1, IOP %.0f mmHg', iop));
...
xlabel('IOP [mmHg]');
ylabel('median relative error vs raw\_branch1');
title('Median relative error against raw\_branch1');
legend('Location', 'best');
hold off;
