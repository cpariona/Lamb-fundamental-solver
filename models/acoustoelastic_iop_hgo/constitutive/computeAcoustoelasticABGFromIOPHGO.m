...
sigma = computeAcoustoelasticPrestressSigma(IOP, R, h);
[lambda, stretchInfo] = solveAcoustoelasticHGOStretch(sigma, mu, k1, k2, varargin{:});
[alpha, beta, gamma, abgInfo] = computeAcoustoelasticAlphaBetaGamma(lambda, mu, k1, k2);
