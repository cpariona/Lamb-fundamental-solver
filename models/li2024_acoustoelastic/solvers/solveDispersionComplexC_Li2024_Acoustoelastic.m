function result = solveDispersionComplexC_Li2024_Acoustoelastic(params, options, seedResult)
%SOLVEDISPERSIONCOMPLEXC_LI2024_ACOUSTOELASTIC Complex-C continuation solver.
%
...
%
% Optional input:
%   seedResult : output from solveDispersion_Li2024_Acoustoelastic. If given,
