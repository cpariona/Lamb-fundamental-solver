...
%SOLVEDISPERSIONIOPHGOATLASBRANCH_LI2024 Solve Li 2024 atlas branch from IOP/HGO parameters.
%
...
for i = 1:numel(requiredFields)
    if ~isfield(params, requiredFields{i})
        error('Missing required Li2024 IOP/HGO atlas parameter: %s', requiredFields{i});
    end
end
