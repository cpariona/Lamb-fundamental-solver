function [M, aux] = buildMatrix_Li2024_Acoustoelastic(alpha, beta, gamma, h, rho, rhoF, fluidBulkModulus, f, c, options)
%BUILDMATRIX_LI2024_ACOUSTOELASTIC Build the 5x5 Li 2024 acoustoelastic matrix.
%
