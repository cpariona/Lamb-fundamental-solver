function branch = solveMRLFEBranchAdaptiveAtlas(name, seedMode, material, geometry, mrlfeParams, options)
%SOLVEMRLFEBRANCHADAPTIVEATLAS Track an mRLFE branch with local adaptive Cp windows.
%
